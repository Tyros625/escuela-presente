...
class CreateStudentAPIRequest extends APIRequest
{
    ...
    {
        return [
            'email.indisposable' => 'El campo :attribute es un correo electrónico desechables',
            'relatives.father_data.email.indisposable' => 'El campo :attribute es un correo electrónico desechables',
            'relatives.mother_data.email.indisposable' => 'El campo :attribute es un correo electrónico desechables',
        ];
    }
}
