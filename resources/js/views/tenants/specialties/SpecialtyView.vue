<template>
	...
	<div
		class="modal fade"
		id="modal-specialties-subjects"
		tabindex="-1"
		aria-labelledby="modal-specialties-subjects-label"
		aria-hidden="true"
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title d-flex align-items-center gap-2" id="modal-specialties-subjects-label">
...
function showModal() {
	const el = document.getElementById("modal-specialties-subjects");
