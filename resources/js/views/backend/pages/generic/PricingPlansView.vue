...
<template>
  ...
  <div class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-xl-3">
        ...
        >
          <template #content>
            <div class="block-header">
              <h3 class="block-title"><i class="fa fa-thumbs-up me-1"></i> Business</h3>
            </div>
            <div class="block-content bg-body-light">
              <div class="py-2">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-xl-3">
        <!-- Startup Plan -->
        <BaseBlock tag="a" href="javascript:void(0)" class="text-center" link-rotate>
          <template #content>
            <div class="block-header">
              <h3 class="block-title">Startup</h3>
            </div>
      ...
      <div class="col-md-6 col-xl-3">
        <!-- VIP Plan -->
        <BaseBlock tag="a" href="javascript:void(0)" class="text-center" link-pop>
          <template #content>
            <div class="block-header">
              <h3 class="block-title">VIP</h3>
            </div>
          ...
          >
            ...
            <tbody>
              ...
              <tr class="bg-body-light">
                <td></td>
                <td>
                  <button type="button" class="btn rounded-pill btn-secondary px-4">
                    Sign Up
                  </button>
                </td>
                <td>
                ...
                <td>
                  <button type="button" class="btn rounded-pill btn-primary px-4">
                    Sign Up
                  </button>
                </td>
                <td>
