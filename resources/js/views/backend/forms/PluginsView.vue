...
<template>
    <!-- Hero -->
    <BasePageHeading title="Form Plugins"
            ...
            <form @submit.prevent>
                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                ...
                                <FlatPickr id="example-flatpickr-default" class="form-control" placeholder="Y-m-d"
                        ...
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                ...
                                <FlatPickr id="example-flatpickr-custom" class="form-control" placeholder="d-m-Y"
                                    v-model="flatPickrState.dateCustom" :config="flatPickrState.configCustom" />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                <label class="form-label" for="example-flatpickr-friendly">Friendly format</label>
                                <FlatPickr id="example-flatpickr-friendly" class="form-control" placeholder="F j, Y"
                                    v-model="flatPickrState.dateFriendly" :config="flatPickrState.configFriendly" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                <FlatPickr id="example-flatpickr-range" class="form-control"
                                    placeholder="Select Date Range" v-model="flatPickrState.dateRange"
                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                ...
                                <FlatPickr id="example-flatpickr-time-standalone" class="form-control"
                        ...
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                <label class="form-label" for="example-flatpickr-time-standalone-24">Standalone (24-hour
                                    format)</label>
                                <FlatPickr id="example-flatpickr-time-standalone-24" class="form-control"
                        ...
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                <label class="form-label" for="example-flatpickr-datetime">Calendar and time
                                    picker</label>
                                <FlatPickr id="example-flatpickr-datetime" class="form-control"
                                    v-model="flatPickrState.timeDateTime" :config="flatPickrState.configDateTime" />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                <label class="form-label" for="example-flatpickr-datetime-24">Calendar and time picker
                                    (24-hour format)</label>
                                <FlatPickr id="example-flatpickr-datetime24" class="form-control"
                                    v-model="flatPickrState.timeDateTime24" :config="flatPickrState.configDateTime24" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                <FlatPickr id="example-flatpickr-inline" class="form-control"
                                    placeholder="Inline Datepicker" v-model="flatPickrState.inlineDefault"
                                    :config="flatPickrState.configInlineDefault" />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-xl-7">
                                <FlatPickr id="example-flatpickr-inline-time" class="form-control"
                                    placeholder="Inline Datetimepicker" v-model="flatPickrState.inlineTime"
        ...
        <BaseBlock title="Vue Color" content-full>
            <form @submit.prevent>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="mb-4">
                            <Slider v-model="vueColorState.colors" style="width: 260px"></Slider>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <form @submit.prevent>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-4">
                        <div class="mb-4">
                            <label class="form-label" for="example-maxlength-group">Input Group</label>
                            <div class="input-group">
                                <input type="email" class="form-control" id="example-maxlength-group"
                                    v-model="maxLength.maxValue" :maxlength="maxLength.max" />
                                <span class="input-group-text"
                                    v-text="maxLength.max - maxLength.maxValue.length"></span>
                            </div>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="example-maxlength-feedback-visible">Visible feedback</label>
                            <input type="text" class="form-control" id="example-maxlength-feedback-visible"
                                v-model="maxLength.maxValue2" :maxlength="maxLength.max2" />
                            <p class="text-danger fs-sm bg-danger-light rounded p-2 mt-2 mb-0">
                                {{ maxLength.max2 - maxLength.maxValue2.length }}
                                characters left
                            </p>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="example-maxlength-feedback-fadein">Fade in feedback</label>
                            <input type="text" class="form-control" id="example-maxlength-feedback-fadein"
                                v-model="maxLength.maxValue3" :maxlength="maxLength.max3" />
                            <p class="animated fadeInDown fs-sm text-muted mt-2 mb-0" v-if="
        ...
        <BaseBlock title="Vue Select" content-full>
            <form @submit.prevent>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-4">
                        <div class="mb-4">
                            <VueSelect v-model="vueSelectState.optionsSelected"
                                :options="vueSelectState.optionsMultiple" placeholder="Choose a value.."></VueSelect>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-4">
                        <div class="mb-4">
                            <VueSelect multiple v-model="vueSelectState.optionsMultipleSelected"
                                :options="vueSelectState.optionsMultiple" placeholder="Choose multiple values..">
                            </VueSelect>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="mb-4">
                        ...
                        <div class="py-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center fs-sm text-muted py-2">
                                <span>0</span>
                                <span>100</span>
                            </div>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="py-4">
                            <VueformSlider v-model="vueformSliderState.valMinMax" :min="0" :max="1000" />
                            <div class="d-flex justify-content-between align-items-center fs-sm text-muted py-2">
                                <span>0</span>
                                <span>1000</span>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="py-4">
                            <VueformSlider v-model="vueformSliderState.valMarks" :min="0" :max="1000" />
                            <div class="d-flex justify-content-between align-items-center fs-sm text-muted py-2">
                                <span>0</span>
                                <span>250</span>
                                <span>500</span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="py-4">
                            <VueformSlider v-model="vueformSliderState.valDouble" :min="0" :max="1000" />
                            <div class="d-flex justify-content-between align-items-center fs-sm text-muted py-2">
                                <span>0</span>
                                <span>250</span>
                                <span>500</span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="py-4">
                            <VueformSlider v-model="vueformSliderState.valNegative" :min="-500" :max="500" />
                            <div class="d-flex justify-content-between align-items-center fs-sm text-muted py-2">
                                <span>-500</span>
                                <span>-250</span>
                                <span>0</span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="py-4">
                            <VueformSlider v-model="vueformSliderState.valStep" :min="-500" :max="500" :step="50" />
                            <div class="d-flex justify-content-between align-items-center fs-sm text-muted py-2">
                                <span>-500</span>
                                <span>-250</span>
                                <span>0</span>
