  ...
  <div class="content">
    ...
    <BaseBlock title="Basic">
      <form @submit.prevent>
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">The most often used inputs you know and love</p>
          </div>
              ...
              <div class="space-y-2">
                <div class="form-check">
                  <input
                    ...
                    checked
                  />
                  <label class="form-check-label" for="example-checkbox-default1"
                    >Option 1</label
                  >
                </div>
                <div class="form-check">
                  ...
                  />
                  <label class="form-check-label" for="example-checkbox-default2"
                    >Option 2</label
                  >
                </div>
                <div class="form-check">
                  <input
                    ...
                    disabled
                  />
                  <label class="form-check-label" for="example-checkbox-default3"
                    >Option 3</label
                  >
                </div>
              </div>
    ...
    <BaseBlock title="Checkbox and Radio Blocks">
      <form @submit.prevent>
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Block based checkboxes which enable you to put any content inside them,
              perfect for modern selections
            </p>
          </div>
          <div class="col-lg-8">
        ...
        <div class="row">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              You could also use block based radios, perfect for custom content selections
              such as modern pricing tables
            </p>
          </div>
          <div class="col-lg-8">
            <div class="row items-push">
                ...
                <div class="form-check form-block">
                  ...
                  <label class="form-check-label" for="example-radio-block1">
                    <span class="d-block fw-normal text-center my-3">
                      ...
                      <span class="d-block fs-2 fw-light py-3 m-3 bg-body-light rounded"
    ...
    <BaseBlock title="Floating Labels">
      <form @submit.prevent>
        <div class="row">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">You can have pure, CSS based, floating labels</p>
          </div>
          <div class="col-lg-8 col-xl-5">
    ...
    <BaseBlock title="States">
      <form @submit.prevent>
        <div class="row">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">There are various states an input can have</p>
          </div>
          <div class="col-lg-8 col-xl-5">
            <div class="mb-4">
    ...
    <BaseBlock title="Sizes">
      <form @submit.prevent>
        <div class="row">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">You can also alter the size of your inputs</p>
          </div>
          <div class="col-lg-8 col-xl-5">
            <div class="mb-4">
