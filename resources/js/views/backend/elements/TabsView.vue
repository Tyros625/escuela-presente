...
<template>
  <!-- Hero -->
  <BasePageHeading title="Tabs" subtitle="Generate tabbed interfaces with ease.">
    <template #extra>
  ...
  <!-- Page Content -->
  <!-- For advanced Tabs usage you can check out https://getbootstrap.com/docs/5.2/components/navs-tabs/ -->
  <div class="content">
    <!-- Vertical Block Tabs -->
    ...
    <div class="row">
        ...
        <BaseBlock class="row g-0">
          <template #content>
            <ul class="nav nav-tabs nav-tabs-block flex-md-column col-md-4" role="tablist">
              ...
              <li class="nav-item d-md-flex flex-md-column">
                <button class="nav-link text-md-start" id="btabs-vertical-settings-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-vertical-settings" role="tab" aria-controls="btabs-vertical-settings"
                  aria-selected="false">
      ...
      <div class="col-lg-6">
        ...
        <BaseBlock class="row flex-md-row-reverse g-0">
          <template #content>
            <ul class="nav nav-tabs nav-tabs-block justify-content-end justify-content-md-start flex-md-column col-md-4"
              role="tablist">
              <li class="nav-item d-md-flex flex-md-column">
                <button class="nav-link text-md-start active" id="btabs-vertical2-home-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-vertical2-home" role="tab" aria-controls="btabs-vertical2-home"
                  aria-selected="true">
                  <i class="fa fa-fw fa-home opacity-50 me-1 d-none d-sm-inline-block"></i>
                  Home
                </button>
              ...
              <li class="nav-item d-md-flex flex-md-column">
                <button class="nav-link text-md-start" id="btabs-vertical2-profile-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-vertical2-profile" role="tab" aria-controls="btabs-vertical2-profile"
                  aria-selected="false">
                  <i class="fa fa-fw fa-user-circle opacity-50 me-1 d-none d-sm-inline-block"></i>
                  Profile
                </button>
              ...
              <li class="nav-item d-md-flex flex-md-column">
                <button class="nav-link text-md-start" id="btabs-vertical2-settings-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-vertical2-settings" role="tab" aria-controls="btabs-vertical2-settings"
                  aria-selected="false">
                  <i class="fa fa-fw fa-cog opacity-50 me-1 d-none d-sm-inline-block"></i>
                  Settings
                </button>
            ...
            <div class="tab-content col-md-8">
              <div class="block-content tab-pane active" id="btabs-vertical2-home" role="tabpanel"
                aria-labelledby="btabs-vertical2-home-tab" tabindex="0">
                <h4 class="fw-semibold">Home Content</h4>
                <p class="fs-sm">
                  Enim elit sollicitudin orci, eget dictum leo mi nec lectus.
                  Nam commodo turpis id lectus scelerisque vulputate. Integer
              ...
              <div class="block-content tab-pane" id="btabs-vertical2-profile" role="tabpanel"
                aria-labelledby="btabs-vertical2-profile-tab" tabindex="0">
                <h4 class="fw-semibold">Profile Content</h4>
                <p class="fs-sm">
                  Mauris tincidunt tincidunt turpis in porta. Integer fermentum
                  tincidunt auctor. Vestibulum ullamcorper, odio sed rhoncus
              ...
              <div class="block-content tab-pane" id="btabs-vertical2-settings" role="tabpanel"
                aria-labelledby="btabs-vertical2-settings-tab" tabindex="0">
                <h4 class="fw-semibold">Settings Content</h4>
                <p class="fs-sm">
                  Integer fermentum tincidunt auctor. Vestibulum ullamcorper,
                  odio sed rhoncus imperdiet, enim elit sollicitudin orci, eget
        ...
        <BaseBlock class="row g-0">
          <template #content>
            <ul class="nav nav-tabs nav-tabs-block flex-md-column col-md-4 col-xxl-2" role="tablist">
              <li class="nav-item d-md-flex flex-md-column">
                <button class="nav-link text-md-start active" id="btabs-vertical-info-home-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-vertical-info-home" role="tab" aria-controls="btabs-vertical-info-home"
                  aria-selected="true">
                  <i class="fa fa-fw fa-home opacity-50 me-1 d-none d-sm-inline-block"></i>
                  <span>Home</span>
              ...
              <li class="nav-item d-md-flex flex-md-column">
                <button class="nav-link text-md-start" id="btabs-vertical-info-profile-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-vertical-info-profile" role="tab" aria-controls="btabs-vertical-info-profile"
                  aria-selected="false">
                  <i class="fa fa-fw fa-user-circle opacity-50 me-1 d-none d-sm-inline-block"></i>
                  <span>Profile</span>
                  <span class="d-none d-md-block fs-xs fw-medium opacity-75 mt-md-2">
              ...
              <li class="nav-item d-md-flex flex-md-column">
                <button class="nav-link text-md-start" id="btabs-vertical-info-settings-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-vertical-info-settings" role="tab" aria-controls="btabs-vertical-info-settings"
                  aria-selected="false">
                  <i class="fa fa-fw fa-cog opacity-50 me-1 d-none d-sm-inline-block"></i>
                  <span>Settings</span>
                  <span class="d-none d-md-block fs-xs fw-medium opacity-75 mt-md-2">
            ...
            <div class="tab-content col-md-8 col-xxl-10">
              <div class="block-content tab-pane active" id="btabs-vertical-info-home" role="tabpanel"
                aria-labelledby="btabs-vertical-info-home-tab" tabindex="0">
                <h4 class="fw-semibold">Home Content</h4>
                <p class="fs-sm">
                  Enim elit sollicitudin orci, eget dictum leo mi nec lectus.
                  Nam commodo turpis id lectus scelerisque vulputate. Integer
              ...
              <div class="block-content tab-pane" id="btabs-vertical-info-settings" role="tabpanel"
                aria-labelledby="btabs-vertical-info-settings-tab" tabindex="0">
                <h4 class="fw-semibold">Settings Content</h4>
                <p class="fs-sm">
                  Integer fermentum tincidunt auctor. Vestibulum ullamcorper,
                  odio sed rhoncus imperdiet, enim elit sollicitudin orci, eget
          ...
          <template #content>
            ...
            <div class="block-content tab-content">
              ...
              <div class="tab-pane" id="btabs-alt-static-settings" role="tabpanel"
                aria-labelledby="btabs-alt-static-settings-tab" tabindex="0">
                <h4 class="fw-normal">Settings Content</h4>
                <p>...</p>
              </div>
            </div>
            ...
            <ul class="nav nav-tabs nav-tabs-block justify-content-end" role="tablist">
              <li class="nav-item me-auto">
                <button class="nav-link" id="btabs-static2-settings-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-static2-settings" role="tab" aria-controls="btabs-static2-settings"
                  aria-selected="false">
                  <i class="si si-settings"></i>
                  <span class="visually-hidden">Settings</span>
                </button>
        ...
        <BaseBlock>
          <template #content>
            <ul class="nav nav-tabs nav-tabs-alt justify-content-end" role="tablist">
              <li class="nav-item me-auto">
                <button class="nav-link" id="btabs-alt-static2-settings-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-alt-static2-settings" role="tab" aria-controls="btabs-alt-static2-settings"
                  aria-selected="false">
                  <i class="si si-settings"></i>
                  <span class="visually-hidden">Settings</span>
                </button>
              ...
              <li class="nav-item">
                <button class="nav-link" id="btabs-alt-static2-profile-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-alt-static2-profile" role="tab" aria-controls="btabs-alt-static2-profile"
                  aria-selected="false">
                  Profile
                </button>
              </li>
              <li class="nav-item">
                <button class="nav-link active" id="btabs-alt-static2-home-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-alt-static2-home" role="tab" aria-controls="btabs-alt-static2-home"
                  aria-selected="true">
                  Home
                </button>
              </li>
            ...
            <div class="block-content tab-content">
              <div class="tab-pane active" id="btabs-alt-static2-home" role="tabpanel"
                aria-labelledby="btabs-alt-static2-home-tab" tabindex="0">
                <h4 class="fw-normal">Home Content</h4>
                <p>...</p>
              </div>
              <div class="tab-pane" id="btabs-alt-static2-profile" role="tabpanel"
                aria-labelledby="btabs-alt-static2-profile-tab" tabindex="0">
                <h4 class="fw-normal">Profile Content</h4>
                <p>...</p>
              </div>
              <div class="tab-pane" id="btabs-alt-static2-settings" role="tabpanel"
                aria-labelledby="btabs-alt-static2-settings-tab" tabindex="0">
                <h4 class="fw-normal">Settings Content</h4>
                <p>...</p>
              </div>
            </div>
            ...
            <ul class="nav nav-tabs nav-tabs-block" role="tablist">
              ...
              <li class="nav-item">
                <button class="nav-link" id="btabs-animated-fade-profile-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-animated-fade-profile" role="tab" aria-controls="btabs-animated-fade-profile"
                  aria-selected="false">
                  Profile
                </button>
              </li>
              <li class="nav-item ms-auto">
                <button class="nav-link" id="btabs-animated-fade-settings-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-animated-fade-settings" role="tab" aria-controls="btabs-animated-fade-settings"
                  aria-selected="false">
                  <i class="si si-settings"></i>
                </button>
              </li>
          ...
          <template #content>
            ...
            <div class="block-content tab-content overflow-hidden">
              ...
              <div class="tab-pane fade fade-up" id="btabs-animated-slideup-settings" role="tabpanel"
                aria-labelledby="btabs-animated-slideup-settings-tab" tabindex="0">
                <h4 class="fw-normal">Settings Content</h4>
                <p>Content slides up..</p>
              </div>
            </div>
        ...
        <BaseBlock>
          <template #content>
            <ul class="nav nav-tabs nav-tabs-block" role="tablist">
              ...
              <li class="nav-item ms-auto">
                <button class="nav-link" id="btabs-animated-slideright-settings-tab" data-bs-toggle="tab"
                  data-bs-target="#btabs-animated-slideright-settings" role="tab"
                  aria-controls="btabs-animated-slideright-settings" aria-selected="false">
                  <i class="si si-settings"></i>
                </button>
              </li>
            </ul>
