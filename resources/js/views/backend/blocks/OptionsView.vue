...
<template>
  <!-- Hero -->
  <BasePageHeading title="Block Options" subtitle="Adding controls to your blocks.">
    <template #extra>
  ...
  <div class="content">
    <h2 class="content-heading">
      Interactive Options
      <small>
        <RouterLink :to="{ name: 'backend-blocks-api' }" class="fw-medium">Check out Blocks API</RouterLink>
      </small>
    </h2>
    ...
    <div class="row">
      <div class="col-md-6">
        <BaseBlock title="Title" subtitle="Subtitle" ref="exampleBlock1" btn-option-fullscreen btn-option-pinned
          btn-option-content btn-option-close>
          <template #options>
            <button type="button" class="btn-block-option" @click="loadDataForBlock1">
      ...
      <div class="col-md-6">
        <BaseBlock rounded title="Title" subtitle="Subtitle" ref="exampleBlock2" header-rtl btn-option-fullscreen
          btn-option-pinned btn-option-content btn-option-close>
          <template #options>
            <button type="button" class="btn-block-option" @click="loadDataForBlock2">
              <i class="si si-refresh"></i>
            </button>
          </template>
