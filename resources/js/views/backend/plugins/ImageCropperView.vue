...
<template>
    <!-- Hero -->
    <BasePageHeading title="Image Cropper" subtitle="Powered by Cropper.js plugin.">
        <template #extra>
    ...
    <div class="content">
        ...
        <BaseBlock class="text-center mb-2" content-class="space-x-1">
            <div class="btn-group push">
                <button type="button" class="btn btn-sm btn-alt-primary" title="Set drag mode to move"
                    @click.prevent="setDragMode('move')">
                    <i class="fa fa-fw fa-arrows-alt"></i>
                </button>
                <button type="button" class="btn btn-sm btn-alt-primary" title="Set drag mode to crop"
                    @click.prevent="setDragMode('crop')">
                    <i class="fa fa-fw fa-crop"></i>
                </button>
            </div>
            <div class="btn-group space-x-2 push">
                <button type="button" class="btn btn-sm btn-alt-primary" title="Zoom In" @click.prevent="zoom(0.1)">
                    <i class="fa fa-fw fa-search-plus"></i>
                </button>
                <button type="button" class="btn btn-sm btn-alt-primary" title="Zoom Out" @click.prevent="zoom(-0.1)">
                    <i class="fa fa-fw fa-search-minus"></i>
                </button>
            </div>
            <div class="btn-group space-x-2 push">
                <button type="button" class="btn btn-sm btn-alt-primary" title="Rotate Left"
                    @click.prevent="rotate(-90)">
                    <i class="fa fa-fw fa-undo-alt"></i>
                </button>
                <button type="button" class="btn btn-sm btn-alt-primary" title="Rotate Right"
                    @click.prevent="rotate(90)">
                    <i class="fa fa-fw fa-redo-alt"></i>
                </button>
            </div>
            <div class="btn-group space-x-2 push">
                <button type="button" class="btn btn-sm btn-alt-primary" title="Flip Horizontal" @click.prevent="flipX"
                    ref="flipXToggle">
                    <i class="fa fa-fw fa-arrows-alt-h"></i>
                </button>
                <button type="button" class="btn btn-sm btn-alt-primary" title="Flip Vertical" @click.prevent="flipY"
                    ref="flipYToggle">
                    <i class="fa fa-fw fa-arrows-alt-v"></i>
                </button>
            </div>
            <div class="btn-group space-x-2 push">
                <button type="button" class="btn btn-sm btn-alt-primary" title="Set Aspect Ratio"
            ...
            <button type="button" class="btn btn-sm btn-alt-primary push" title="Set Aspect Ratio"
                @click.prevent="setAspectRatio(NaN)">
                Free
            </button>
            <div class="btn-group space-x-2 push">
                <button type="button" class="btn btn-sm btn-alt-primary" title="Clear" @click.prevent="reset">
                    <i class="fa fa-fw fa-times"></i>
                </button>
                <button type="button" class="btn btn-sm btn-alt-primary" title="Crop" @click.prevent="getCropBoxData">
        ...
        <BaseBlock content-full>
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <div>
                        <vue-cropper ref="cropper" :aspect-ratio="4 / 3" :src="imgSrc" alt="Source Image"
                            preview=".js-img-cropper-preview"></vue-cropper>
                    </div>
                </div>
                <div class="col-xl-6">
