      ...
      <div class="content content-full">
        <div class="row g-0 justify-content-center text-center">
          <div class="col-md-10 pt-7 pb-9">
            <div class="d-inline-flex align-items-center space-x-1 fs-sm badge bg-danger-light text-danger mb-2 p-2">
      ...
      <div class="content content-full">
        <div class="px-lg-8 text-center">
          <BaseBlock fx-shadow class="overflow-hidden" content-class="p-2" style="margin-top: -200px">
            <img class="img-fluid" src="/assets/media/various/hero-promo.png" alt="Hero Promo Light Dashboard" />
          </BaseBlock>
        </div>
        <div class="row py-5">
          ...
          <div class="col-6 col-md-3">
            ...
            <p class="text-muted">
              A brand new Laravel 9 with Vite integration version is now
              included.
            </p>
          </div>
          <div class="col-6 col-md-3">
        ...
        <div class="py-5 text-center">
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <h2 class="h1 fw-bold mb-2">
                Trusted by over 4,900 developers and teams
              </h2>
              <p class="fs-lg fw-medium text-muted mb-0">
