...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Admin WhatsApp URL (optional)
    |--------------------------------------------------------------------------
    | Shown on tenant-disabled page when tenant has no phone. e.g. https://wa.me/5215512345678
    */
    'admin_whatsapp_url' => env('ADMIN_WHATSAPP_URL', null),
